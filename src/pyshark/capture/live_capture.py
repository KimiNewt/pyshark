...
class LiveCapture(Capture):
    """epresents a live capture on a network interface."""
    ...
    def __init__(self, interface=None, bpf_filter=None, display_filter=None, only_summaries=False,
        ...
        :param custom_parameters: WARNING dict of custom parameters to pass to tshark, i.e. {"--param": "value"} or
    ...
    def sniff_continuously(self, packet_count=None):
        ...
        for packet in capture.sniff_continuously():
            print('oo, another packet:', packet)
        ...
        """
        # etained for backwards compatibility and to add documentation.
